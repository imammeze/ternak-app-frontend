...
export default function PresensiMasukPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.post("/api/absen/masuk", formData);
    ...
    <>
      ...
      <div className="flex-1 bg-slate-50 px-5 pt-6 pb-32 overflow-y-auto">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col items-center justify-center mb-5 relative overflow-hidden">
          ...
          <h2 className="text-5xl font-black text-emerald-600 tracking-tight z-10 tabular-nums">
            {isClient ? timeString : "--.--.--"}
          </h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="flex flex-col border border-gray-200 rounded-xl p-3.5 bg-white shadow-sm focus-within:border-emerald-500 focus-within:ring-1 focus-within:ring-emerald-200 transition-all">
