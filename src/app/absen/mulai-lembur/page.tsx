...
export default function MulaiLemburPage() {
  ...
  return (
    <>
      <div className="flex items-center px-4 pt-10 pb-4 bg-amber-500 text-white z-10 sticky top-0 shadow-sm">
      ...
      <div className="flex-1 bg-slate-50 px-5 pt-6 pb-32 overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="flex flex-col border border-gray-200 rounded-xl p-3.5 bg-white shadow-sm focus-within:border-amber-500 focus-within:ring-1 focus-within:ring-amber-200 transition-all">
          ...
          <button
            ...
            className={`mt-2 w-full text-white font-bold py-4 rounded-xl shadow-lg transition-all tracking-wider flex justify-center items-center gap-2 ${
              isSubmitting || lokasiLoading || !!lokasiError
                ...
                : "bg-amber-500 hover:bg-amber-600 shadow-amber-200 active:scale-[0.98]"
            }`}>
            {isSubmitting ? (
